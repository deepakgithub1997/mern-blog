  ...
  return (
    <div className='min-h-screen flex items-center justify-center'>
      <div className='max-w-2xl mx-auto p-3 text-center'>
        <div className=''>
          <h1 className="text-3xl font font-semibold text-center my-7">About Deepak Blog's</h1>
          <div className='text-md text-gray-500 flex flex-col gap-6'>
            <p>
              Welcome to Deepak's Blog! This blog was created by Deepak as a personal project to
              share his thoughts and ideas with the world. Deepak is a passionate developer who loves to
            ...
            <p>
              ...
              software engineering, and programming languages. Deepak is always learning and exploring
